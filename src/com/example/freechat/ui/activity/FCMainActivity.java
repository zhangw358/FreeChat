...
public class FCMainActivity extends FCActionBarActivity {
    ...
    private void initFragment() {
        ...
        m_fragments[0] = m_fragmentManager.findFragmentById(R.id.fragment_friend);
        m_fragments[1] = m_fragmentManager.findFragmentById(R.id.fragment_session);
        m_fragmentTransaction = m_fragmentManager.beginTransaction().hide(m_fragments[0]).hide(m_fragments[1]);
    ...
    private void setFragIndicator() {
        ...
        m_bottomGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
